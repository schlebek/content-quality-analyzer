...
if ( ! function_exists( 'cqa_autoload' ) ) {
...
if ( ! function_exists( 'cqa_activate' ) ) {
...
if ( ! function_exists( 'cqa_uninstall' ) ) {
...
if ( ! function_exists( 'cqa_load_textdomain' ) ) {
...
if ( ! function_exists( 'cqa_invalidate_cache' ) ) {
